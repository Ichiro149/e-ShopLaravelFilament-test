...
@media (max-width: 900px) {
    ...
    #address-modal .settings-modal-backdrop {
        position: fixed !important;
        top: -1px !important;
        left: 0 !important;
        right: 0 !important;
    ...
    #address-modal .settings-modal-container {
        position: fixed !important;
        bottom: 0 !important;
        left: 0 !important;
        right: 0 !important;
    ...
    #address-modal .settings-modal-content {
        border-radius: 20px 20px 0 0 !important;
    }
    #address-modal .settings-modal-body {
        max-height: 60vh !important;
        padding: 16px !important;
    }
    #address-modal .form-row-2col {
        display: block !important;
    }
    #address-modal .form-row-2col .form-group {
        margin-bottom: 12px;
    }
    #address-modal .settings-modal-footer {
        flex-direction: column !important;
        padding: 12px 16px 24px !important;
    }
    #address-modal .settings-modal-footer .settings-btn {
        width: 100% !important;
    }
}
</style>
