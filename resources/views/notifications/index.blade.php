    ...
    <div class="notifications-container">
                    ...
                    <div class="notification-card-header">
                        ...
                        <div class="notification-card-content">
                            <div class="notification-card-message">
                                {{ $notification->data['message'] ?? __('notifications.no_notifications') }}
                            </div>
        ...
        @else
            <div class="empty-state">
                ...
                <h2 class="empty-state-title">{{ __('notifications.no_notifications') }}</h2>
                <p class="empty-state-description">{{ __('notifications.empty_message') }}</p>
            </div>
        @endif
    </div>
</div>
